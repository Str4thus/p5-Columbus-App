...
export class HelloworldComponent implements OnInit {
  ...
  _updateCameraDisplayState() {
    if (this.cameraController.canOperate()) {
      this.color = "success";
  ...
  // Controller Stuff
  conRotateH() {
    this.cameraController.rotateHorizontally(this.cameraController.getStateData("hrot") + 10);
  }

  conRotateV() {
    this.cameraController.rotateVertically(this.cameraController.getStateData("vrot") + 10);
  }
  ...
  openSocket() {
    ...
    this.socketColor = "success";
    this.socketState = "Open";
    this._updateCameraDisplayState();
  }

  closeSocket() {
    this.socket.close();
    this.socketColor = "danger";
  ...
  disconnectCamera() {
    this.socket.disconnectCamera();
    this._updateCameraDisplayState();
  }

  rotateH() {
    this.socket.turnCameraHorizontally(this.cameraController.getStateData("hrot") + 10);
  }

  rotateV() {
    this.socket.turnCameraVertically(this.cameraController.getStateData("vrot") + 10);
  }

  updateImg() {
    this.socket.updateCameraImage();
    this.imgSource = this.cameraController.getStateData("img");
  }
}
